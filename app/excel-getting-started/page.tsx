...
export default function ExcelGettingStarted() {
  return (
    <main className="flex-grow pb-24 bg-[#050B14]">
      ...
      <div className="bg-[#050B14] pt-8 pb-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center text-xs text-gray-400 gap-2 font-medium">
            ...
            <span className="text-gray-600">/</span>
            <span className="text-green-400 bg-green-900/20 px-2 py-0.5 rounded">Excel Basics & Essentials</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-[#050B14] pb-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-8 leading-tight max-w-4xl">
            Excel Basics & Essentials: Grid Navigation, Data Entry & Workbook Setup
          </h1>
          ...
          <div className="bg-[#0b1220] border border-green-500/20 rounded-2xl p-6 relative overflow-hidden mb-8 shadow-2xl">
            ...
            <p className="text-justify text-sm md:text-base text-gray-300 leading-relaxed font-medium">
              &laquo;Master the absolute fundamentals of Microsoft Excel. This specialized hub provides step-by-step guides on navigating rows and columns, entering and formatting data types, managing multiple worksheets, and configuring secure workbook properties in Microsoft 365.&raquo;
            </p>
          </div>
          ...
          <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
            <div className="flex items-center gap-8 flex-wrap">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-gray-300">Microsoft 365 & Excel Essentials</span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-[#0b1220] border border-green-500/20 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-2xl">
            <div className="p-8 md:w-1/2 flex flex-col justify-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Free Excel Basics Cheat Sheet</h2>
              <p className="text-justify text-sm text-gray-400 mb-8 max-w-md">
                Includes quick-reference grid navigation shortcuts, workbook setup guides, data entry tips, and file management rules.
              </p>
            ...
            <div className="p-8 md:w-1/2 bg-white/[0.02] backdrop-blur-sm flex items-center justify-center border-l border-[#1E2536]/50">
              <div className="bg-[#050B14] border border-[#1E2536]/50 rounded-xl p-5 w-full max-w-md font-mono text-xs shadow-xl">
                <div className="flex justify-between items-center mb-5 border-b border-[#1E2536]/50 pb-3">
                  <span className="text-gray-300 flex items-center gap-2"><FileText className="w-4 h-4 text-green-400"/> Excel_Basics_CheatSheet_2026.pdf</span>
                  <span className="bg-green-600/20 text-green-400 px-2 py-1 rounded text-[10px] font-bold">PDF 2.2 MB</span>
                </div>
                <div className="text-green-400 mb-2 font-semibold">1. Quick Workbook Navigation:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 mb-5 whitespace-pre-wrap">
                  &quot;Ctrl + Home (Cell A1) | Ctrl + End (Last Used Cell)&quot;
                </div>
                <div className="text-green-400 mb-2 font-semibold">2. Worksheet Management:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 whitespace-pre-wrap">
                  &quot;Shift + F11 (Insert New Sheet) | Ctrl + Page Up/Down (Switch Sheets)&quot;
                </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h2 className="text-2xl md:text-3xl font-bold text-white">Excel Basics Tutorials</h2>
                <span className="bg-green-600 text-white px-2.5 py-1 rounded-full text-xs font-bold">3 Guides</span>
              </div>
              <p className="text-justify text-sm text-gray-400 max-w-2xl">Explore fundamental tutorials covering workbook layout, grid management, and error-free data entry.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Grid Layout</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Understanding Rows, Columns, Cells, and the Formula Bar</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">A complete beginner walkthrough on moving around the spreadsheet grid and understanding cell coordinates.</p>
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Data Entry</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Entering Text, Numbers, and Using Flash Fill Effectively</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Learn how Excel handles different data types and how to auto-format text patterns using Flash Fill.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Workbook Setup</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Creating, Saving, and Organizing Multiple Worksheets</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Step-by-step instructions on renaming tabs, color-coding sheets, and securing workbooks with passwords.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
                <span className="flex items-center gap-1 text-[10px] font-bold text-gray-500 tracking-widest uppercase bg-white/[0.02] px-2 py-1 rounded"><Play className="w-3 h-3 text-red-500 fill-current" /> Video</span>
                <Link href="/article-landing" className="text-xs font-bold text-green-400 hover:text-green-300 transition-colors">Read Full Tutorial →</Link>
              </div>
      ...
      <section className="py-16 bg-[#050B14]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-justify text-sm text-gray-400 mb-8">Common technical questions regarding Excel Basics & Essentials.</p>
          ...
          <div className="space-y-4">
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-green-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">How do I freeze top rows and columns for easy scrolling?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-green-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">Why are numbers showing up as green triangles in the top left corner?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
          </div>
        </div>
