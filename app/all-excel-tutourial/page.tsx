    ...
    <main className="flex-grow pb-24 bg-[#050B14]">
      ...
      <div className="bg-[#050B14] pt-8 pb-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center text-xs text-gray-400 gap-2 font-medium">
            ...
            <span className="text-green-400 bg-green-900/20 px-2 py-0.5 rounded">All MS Excel Tutorials & Master Library</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-[#050B14] pb-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-8 leading-tight max-w-4xl">
            All Microsoft Excel Tutorials: Master Guides, Formulas & Data Analytics
          </h1>
          ...
          <div className="bg-[#0b1220] border border-green-500/20 rounded-2xl p-6 relative overflow-hidden mb-8 shadow-2xl">
            ...
            <p className="text-justify text-sm md:text-base text-gray-300 leading-relaxed font-medium">
              &laquo;Welcome to the comprehensive Microsoft Excel tutorial library. Explore every structured guide covering spreadsheet essentials, advanced formulas (XLOOKUP, INDEX/MATCH), pivot tables, data visualization, and AI Copilot integrations designed for professionals and financial analysts.&raquo;
            </p>
          </div>
          ...
          <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
            <div className="flex items-center gap-8 flex-wrap">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-gray-300">Microsoft 365, Excel 2026 & Data Toolsets</span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-[#0b1220] border border-green-500/20 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-2xl">
            <div className="p-8 md:w-1/2 flex flex-col justify-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Complete Microsoft Excel Formula Cheat Sheet</h2>
              <p className="text-justify text-sm text-gray-400 mb-8 max-w-md">
                Master 50+ essential spreadsheet shortcuts, lookup formulas, data validation rules, and financial modeling tips in one handy reference sheet.
              </p>
              <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg text-sm font-bold transition-colors w-fit flex items-center gap-2 shadow-lg">
                <Download className="w-4 h-4" /> Download Master Excel Cheat Sheet →
              </button>
            </div>
            <div className="p-8 md:w-1/2 bg-white/[0.02] backdrop-blur-sm flex items-center justify-center border-l border-[#1E2536]/50">
              <div className="bg-[#050B14] border border-[#1E2536]/50 rounded-xl p-5 w-full max-w-md font-mono text-xs shadow-xl">
                <div className="flex justify-between items-center mb-5 border-b border-[#1E2536]/50 pb-3">
                  <span className="text-gray-300 flex items-center gap-2"><FileText className="w-4 h-4 text-green-400"/> MS_Excel_Master_Formulas_2026.pdf</span>
                  <span className="bg-green-600/20 text-green-400 px-2 py-1 rounded text-[10px] font-bold">PDF 3.4 MB</span>
                </div>
                <div className="text-green-400 mb-2 font-semibold">1. Quick Navigation & Selection:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 mb-5 whitespace-pre-wrap">
                  &quot;Ctrl + Shift + Down (Select Data Column) | Ctrl + ; (Current Date)&quot;
                </div>
                <div className="text-green-400 mb-2 font-semibold">2. Essential Formula Hotkeys:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 whitespace-pre-wrap">
                  &quot;F4 (Lock Cell Reference $) | Alt + = (AutoSum Shortcut)&quot;
                </div>
                <div className="text-center text-gray-500 mt-6 text-[10px] italic">
                  + Complete formula grid included in full PDF download
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h2 className="text-2xl md:text-3xl font-bold text-white">All Excel Tutorials & Guides</h2>
                <span className="bg-green-600 text-white px-2.5 py-1 rounded-full text-xs font-bold">All Categories</span>
              </div>
              <p className="text-justify text-sm text-gray-400 max-w-2xl">Browse through our complete library of Excel tutorials spanning basic grid setup to advanced data analytics.</p>
            </div>
            
            <div className="flex flex-col gap-4 w-full md:w-auto">
              <div className="relative">
                <Search className="w-4 h-4 text-gray-500 absolute left-3 top-1/2 -translate-y-1/2" />
                <input type="text" placeholder="Search all tutorials..." className="w-full md:w-64 bg-[#0b1220] border border-[#1E2536]/50 rounded-lg pl-9 pr-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-green-500 transition-colors" />
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Essentials</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Understanding Excel Grids, Rows, Columns, and Basic Data Entry</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">A complete beginner walkthrough on navigating worksheets, cell formatting types, and autofill sequences.</p>
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Formulas</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Mastering XLOOKUP, SUMIFS, and Logical IF Statements</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Learn how to combine lookup functions and conditional math statements to build robust dynamic financial models.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">AI & Copilot</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Automating PivotTables and Data Trends Using Copilot</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Leverage natural language prompts to instantly generate summary reports, charts, and forecast models.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
                <span className="flex items-center gap-1 text-[10px] font-bold text-gray-500 tracking-widest uppercase bg-white/[0.02] px-2 py-1 rounded"><Play className="w-3 h-3 text-red-500 fill-current" /> Video</span>
                <Link href="/article-landing" className="text-xs font-bold text-green-400 hover:text-green-300 transition-colors">Read Full Tutorial →</Link>
              </div>
      ...
      <section className="py-16 bg-[#050B14]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-justify text-sm text-gray-400 mb-8">General queries regarding Microsoft Excel tutorials and learning resources.</p>
          ...
          <div className="space-y-4">
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-green-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">Can I use older versions of Excel for these tutorials?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-green-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">Are downloadable practice spreadsheets provided with every guide?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
          </div>
        </div>
