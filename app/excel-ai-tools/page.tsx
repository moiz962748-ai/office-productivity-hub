...
export default function ExcelAiTools() {
  return (
          ...
          <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
            <div className="flex items-center gap-8 flex-wrap">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-gray-300">Microsoft 365 Copilot & Excel AI Toolsets</span>
              </div>
            </div>
            ...
            <div className="p-8 md:w-1/2 bg-white/[0.02] backdrop-blur-sm flex items-center justify-center border-l border-[#1E2536]/50">
              <div className="bg-[#050B14] border border-[#1E2536]/50 rounded-xl p-5 w-full max-w-md font-mono text-xs shadow-xl">
                <div className="flex justify-between items-center mb-5 border-b border-[#1E2536]/50 pb-3">
                  <span className="text-gray-300 flex items-center gap-2"><FileText className="w-4 h-4 text-green-400"/> Excel_Copilot_Formula_CheatSheet.pdf</span>
                  <span className="bg-green-600/20 text-green-400 px-2 py-1 rounded text-[10px] font-bold">PDF 2.5 MB</span>
                </div>
                <div className="text-green-400 mb-2 font-semibold">1. Formula Generation Prompt:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 mb-5 whitespace-pre-wrap">
                  &quot;Write an XLOOKUP formula to find sales total where region equals...&quot;
                </div>
                <div className="text-green-400 mb-2 font-semibold">2. Data Insights Prompt:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 whitespace-pre-wrap">
                  &quot;Highlight top 3 anomalies in monthly expense trends&quot;
                </div>
                <div className="text-center text-gray-500 mt-6 text-[10px] italic">
                  + 30+ additional prompts included in full PDF download
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            <div>
              ...
              <p className="text-justify text-sm text-gray-400 max-w-2xl">Explore advanced tutorials covering Microsoft Copilot, natural language formula generation, and automated data analysis.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Formula Prompts</span>
              </div>
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Data Analysis</span>
              </div>
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Advanced Analytics</span>
              </div>
