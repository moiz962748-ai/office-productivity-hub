    ...
    <main className="flex-grow pb-24 bg-[#050B14]">
      ...
      <div className="bg-[#050B14] pt-8 pb-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center text-xs text-gray-400 gap-2 font-medium">
            ...
            <span className="text-gray-600">/</span>
            <span className="text-blue-400 bg-blue-900/20 px-2 py-0.5 rounded">Formatting & Design in Microsoft Word</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-[#050B14] pb-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-8 leading-tight max-w-4xl">
            Formatting & Document Design in Microsoft Word: Typography, Styles & Layouts
          </h1>
          ...
          <div className="bg-[#0b1220] border border-blue-500/20 rounded-2xl p-6 relative overflow-hidden mb-8 shadow-2xl">
            ...
            <p className="text-justify text-sm md:text-base text-gray-300 leading-relaxed font-medium">
              &laquo;Master professional document formatting and visual design in Microsoft Word. This specialized hub provides step-by-step guides on applying custom typography, creating consistent styles, setting up multi-column layouts, managing headers and footers, and designing visually polished reports.&raquo;
            </p>
          </div>
          ...
          <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
            <div className="flex items-center gap-8 flex-wrap">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-gray-300">Microsoft 365 & Advanced Formatting Standards</span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-[#0b1220] border border-blue-500/20 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-2xl">
            <div className="p-8 md:w-1/2 flex flex-col justify-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Free Typography & Styles Cheat Sheet</h2>
              <p className="text-justify text-sm text-gray-400 mb-8 max-w-md">
                Includes quick-reference layout rules, style hierarchy guidelines, paragraph spacing tricks, and shortcut keys for rapid styling.
              </p>
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg text-sm font-bold transition-colors w-fit flex items-center gap-2 shadow-lg">
                <Download className="w-4 h-4" /> Download Formatting Cheat Sheet →
              </button>
            </div>
            <div className="p-8 md:w-1/2 bg-white/[0.02] backdrop-blur-sm flex items-center justify-center border-l border-[#1E2536]/50">
              <div className="bg-[#050B14] border border-[#1E2536]/50 rounded-xl p-5 w-full max-w-md font-mono text-xs shadow-xl">
                <div className="flex justify-between items-center mb-5 border-b border-[#1E2536]/50 pb-3">
                  <span className="text-gray-300 flex items-center gap-2"><FileText className="w-4 h-4 text-blue-400"/> MS_Word_Formatting_CheatSheet_2026.pdf</span>
                  <span className="bg-blue-600/20 text-blue-400 px-2 py-1 rounded text-[10px] font-bold">PDF 2.8 MB</span>
                </div>
                <div className="text-blue-400 mb-2 font-semibold">1. Quick Paragraph Alignment:</div>
                ...
                <div className="text-blue-400 mb-2 font-semibold">2. Font & Size Adjustments:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 whitespace-pre-wrap">
                  &quot;Ctrl + Shift + Greater/Lesser (Grow/Shrink Font Size)&quot;
                </div>
                <div className="text-center text-gray-500 mt-6 text-[10px] italic">
                  + Complete formatting hotkey grid included in full PDF download
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h2 className="text-2xl md:text-3xl font-bold text-white">Formatting & Design Tutorials</h2>
                <span className="bg-blue-600 text-white px-2.5 py-1 rounded-full text-xs font-bold">3 Guides</span>
              </div>
              <p className="text-justify text-sm text-gray-400 max-w-2xl">Explore advanced layout tutorials covering typography rules, style sheets, and professional document presentation.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-blue-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-blue-900/20 text-blue-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-blue-500/10">Typography</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-blue-400 transition-colors cursor-pointer">Mastering Font Hierarchies, Line Spacing, and Paragraph Rules</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Learn how to establish clean typographic contrast using heading styles, leading controls, and block spacing rules.</p>
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-blue-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-blue-900/20 text-blue-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-blue-500/10">Style Sheets</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-blue-400 transition-colors cursor-pointer">Creating Custom Styles and Global Document Themes</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Discover how to build custom style sets to update fonts and colors across 100+ pages instantly with a single click.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-blue-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-blue-900/20 text-blue-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-blue-500/10">Layout Design</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-blue-400 transition-colors cursor-pointer">Designing Multi-Column Newsletters and Custom Page Borders</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Step-by-step instructions for breaking pages into columns, inserting section breaks, and adding aesthetic visual framing.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
                <span className="flex items-center gap-1 text-[10px] font-bold text-gray-500 tracking-widest uppercase bg-white/[0.02] px-2 py-1 rounded"><Play className="w-3 h-3 text-red-500 fill-current" /> Video</span>
                <Link href="/article-landing" className="text-xs font-bold text-blue-400 hover:text-blue-300 transition-colors">Read Full Tutorial →</Link>
              </div>
      ...
      <section className="py-16 bg-[#050B14]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-justify text-sm text-gray-400 mb-8">Common technical questions regarding Formatting & Design in Microsoft Word.</p>
          ...
          <div className="space-y-4">
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-blue-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">How do I prevent formatting from breaking when pasting text?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-blue-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">Can I save a custom layout as a template for future reports?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
          </div>
        </div>
