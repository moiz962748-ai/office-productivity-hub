...
export default function ExcelSubHub() {
  return (
    <main className="flex-grow pb-24">
      ...
      <div className="bg-[#0A0E1A] pt-8 pb-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center text-xs text-gray-400 gap-2 font-medium">
            ...
            <Link href="/excel-hub" className="hover:text-white transition-colors">Microsoft Excel Master Hub</Link>
            <span className="text-gray-600">/</span>
            <span className="text-green-400 bg-green-900/20 px-2 py-0.5 rounded">AI Tools & Copilot in Microsoft Excel</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-[#0A0E1A] pb-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-8 leading-tight max-w-4xl">
            AI Tools & Copilot in Microsoft Excel: Formulas, Insights & Data Automation
          </h1>

          {/* Master Hub Summary Card */}
          <div className="bg-white/[0.02] backdrop-blur-sm border border-green-500/20 rounded-2xl p-6 relative overflow-hidden mb-8 shadow-2xl">
            ...
            <p className="text-justify text-sm md:text-base text-gray-300 leading-relaxed font-medium">
              &laquo;Transform raw data into strategic business insights using AI in Microsoft Excel. Master natural language formula generation, automated PivotTable creation, Python-in-Excel automation, and Copilot data trend analysis.&raquo;
            </p>
          </div>
          ...
          <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
            <div className="flex items-center gap-8 flex-wrap">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-gray-300">Microsoft 365 Copilot & Excel 2026 Integrations</span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-white/[0.02] backdrop-blur-sm border border-blue-500/20 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-2xl">
            <div className="p-8 md:w-1/2 flex flex-col justify-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Free Excel Copilot Formula Cheat Sheet</h2>
              <p className="text-justify text-sm text-gray-400 mb-8 max-w-md">
                Download 30+ tested Copilot prompts for nested XLOOKUPs, INDEX/MATCH, Power Query formulas, and financial modeling.
              </p>
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg text-sm font-bold transition-colors w-fit flex items-center gap-2 shadow-lg">
                <Download className="w-4 h-4" /> Download Excel Formula Cheat Sheet →
              </button>
            </div>
            <div className="p-8 md:w-1/2 bg-white/[0.02] backdrop-blur-sm flex items-center justify-center border-l border-[#1E2536]/50">
              ...
              <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-xl p-5 w-full max-w-md font-mono text-xs shadow-xl">
                <div className="flex justify-between items-center mb-5 border-b border-[#1E2536]/50 pb-3">
                  <span className="text-gray-300 flex items-center gap-2"><FileText className="w-4 h-4 text-blue-400"/> Excel_Copilot_Formula_CheatSheet_2026.pdf</span>
      ...
      <section className="py-12 border-t border-[#1E2536]/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Step 1 */}
            <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-2xl p-6 relative overflow-hidden group hover:border-green-500/30 transition-colors shadow-xl">
              <div className="flex justify-between items-center mb-6">
                <div className="w-8 h-8 rounded-full bg-green-900 border border-green-500 text-green-400 flex items-center justify-center font-bold text-xs">01</div>
                <div className="flex items-center gap-3">
                  <span className="text-xs text-gray-500 flex items-center gap-1"><Clock className="w-3 h-3"/> 8 mins</span>
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-2xl p-6 relative overflow-hidden group hover:border-green-500/30 transition-colors shadow-xl">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-xs text-gray-500 flex items-center gap-1"><Clock className="w-3 h-3"/> 12 mins</span>
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-2xl p-6 relative overflow-hidden group hover:border-green-500/30 transition-colors shadow-xl">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-xs text-gray-500 flex items-center gap-1"><Clock className="w-3 h-3"/> 18 mins</span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto">
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="Filter articles..." className="w-full md:w-64 bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-lg pl-9 pr-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-green-500 transition-colors" />
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-[#1E2536]/50 transition-colors shadow-xl">
              ...
              <div className="bg-black/40 border border-[#1E2536]/50 rounded-lg p-3 mb-4 mt-2">
                <p className="text-justify text-xs text-gray-400 font-mono truncate"><span className="text-blue-400">&gt; Copilot:</span> Convert business logic into error-free ...</p>
              </div>

              <div className="flex gap-2 mb-4">
                <span className="bg-blue-900/20 text-blue-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-blue-500/10">Formula Prompts</span>
              </div>
              
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">How to Write Nested Excel Formulas in Plain English Using Copilot</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Convert business logic into error-free Excel formulas like XLOOKUP, IF/AND, and SUMIFS using simple prompts.</p>
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-[#1E2536]/50 transition-colors shadow-xl">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-xs text-gray-500 flex items-center gap-1"><Clock className="w-3 h-3"/> 9 min read</span>
              </div>
              
              {/* Snippet block */}
              <div className="bg-black/40 border border-[#1E2536]/50 rounded-lg p-3 mb-4 mt-2">
                <p className="text-justify text-xs text-gray-400 font-mono truncate"><span className="text-blue-400">&gt; Copilot:</span> Generate full summary PivotTables, cros...</p>
              </div>

              <div className="flex gap-2 mb-4">
                <span className="bg-blue-900/20 text-blue-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-blue-500/10">Data Analysis</span>
              </div>
              
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Automating PivotTables and Insights with Copilot in Excel</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Generate full summary PivotTables, cross-tabulations, and key trend insights from raw sales logs with one click.</p>
            ...
            <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-[#1E2536]/50 transition-colors shadow-xl">
              <div className="flex justify-between items-center mb-4">
                ...
                <span className="text-xs text-gray-500 flex items-center gap-1"><Clock className="w-3 h-3"/> 11 min read</span>
              </div>
              
              {/* Snippet block */}
              <div className="bg-black/40 border border-[#1E2536]/50 rounded-lg p-3 mb-4 mt-2">
                <p className="text-justify text-xs text-gray-400 font-mono truncate"><span className="text-blue-400">&gt; Copilot:</span> Combine native Python execution in Exce...</p>
              </div>

              <div className="flex gap-2 mb-4">
                <span className="bg-blue-900/20 text-blue-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-blue-500/10">Advanced Analytics</span>
              </div>
              
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Python in Excel + Copilot: Running Machine Learning in Grid Cells</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Combine native Python execution in Excel with AI prompts to run predictive modeling and sentiment classification.</p>
          ...
          <div className="bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-2xl p-2 pb-0 overflow-hidden shadow-2xl">
            <div className="p-6 pb-4">
              ...
              <div className="flex justify-between items-start gap-4">
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">How to Use Microsoft Copilot in Excel for Fast Data Analysis & Formulas</h2>
                <div className="shrink-0 bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 px-3 py-1.5 rounded-lg text-xs font-bold text-gray-300">
                  Duration: <span className="text-white">15m 45s</span>
                </div>
              </div>
              ...
              <div className="aspect-video bg-[#0A0E1A] rounded-xl border border-[#1E2536]/50 relative flex flex-col items-center justify-center cursor-pointer group">
                ...
                <div className="text-center">
                  ...
                  <p className="text-justify text-xs text-gray-500 max-w-sm">Watch a step-by-step video tutorial demonstrating natural language formula generation and automated chart creation in Excel.</p>
                </div>
              </div>
      ...
      <section className="py-12 border-t border-[#1E2536]/50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-white">Explore More Sub-Hubs in Microsoft Excel</h2>
            <Link href="/excel-hub" className="text-sm font-semibold text-green-400 hover:text-green-300 transition-colors hidden md:flex items-center gap-1">
              ← Back to Microsoft Excel Master Hub
            </Link>
          </div>
          ...
          <div className="flex overflow-x-auto gap-4 pb-4 snap-x snap-mandatory hide-scrollbar">
            ...
            {/* Silo 3 (Current) */}
            <div className="shrink-0 w-64 bg-green-900/20 border border-green-500/30 rounded-xl p-4 snap-start relative shadow-xl">
              <span className="text-[10px] font-bold text-gray-400 tracking-widest uppercase mb-1 block">Silo 03</span>
              <h3 className="text-sm font-bold text-white mb-2">AI Tools & Copilot in Excel</h3>
              <span className="bg-green-600 text-white text-[10px] font-bold px-2 py-0.5 rounded inline-block">Current Hub</span>
            </div>
            {/* Silo 4 */}
            <div className="shrink-0 w-64 bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-xl p-4 snap-start hover:border-[#1E2536]/50 transition-colors cursor-pointer">
            ...
            <div className="shrink-0 w-64 bg-white/[0.02] backdrop-blur-sm border border-[#1E2536]/50 rounded-xl p-4 snap-start hover:border-[#1E2536]/50 transition-colors cursor-pointer">
              ...
              <h3 className="text-sm font-bold text-white">Excel Resources & Downloads</h3>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-justify text-sm text-gray-400 mb-8">Common technical questions regarding AI Tools & Copilot in Microsoft Excel.</p>
