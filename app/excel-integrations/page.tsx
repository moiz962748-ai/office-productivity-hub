...
export default function ExcelIntegrations() {
  return (
    <main className="flex-grow pb-24 bg-[#050B14]">
      ...
      <div className="bg-[#050B14] pt-8 pb-4">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center text-xs text-gray-400 gap-2 font-medium">
            ...
            <span className="text-gray-600">/</span>
            <span className="text-green-400 bg-green-900/20 px-2 py-0.5 rounded">Integrations & Analytics in Microsoft Excel</span>
          </div>
        </div>
      </div>
      ...
      <section className="bg-[#050B14] pb-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white tracking-tight mb-8 leading-tight max-w-4xl">
            Integrations & Analytics in Microsoft Excel: Connecting Power Query, SQL & Cloud Data
          </h1>
          ...
          <div className="bg-[#0b1220] border border-green-500/20 rounded-2xl p-6 relative overflow-hidden mb-8 shadow-2xl">
            ...
            <p className="text-justify text-sm md:text-base text-gray-300 leading-relaxed font-medium">
              &laquo;Learn how to connect Microsoft Excel with external databases, Power Query pipelines, SQL servers, and cloud analytics dashboards. This specialized hub provides step-by-step guides on automating ETL data refreshes, linking Power BI reports, and streamlining enterprise workflows.&raquo;
            </p>
          </div>
          ...
          <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
            <div className="flex items-center gap-8 flex-wrap">
              ...
              <div>
                ...
                <span className="text-sm font-semibold text-gray-300">Microsoft 365 Integrations & Data Pipelines</span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="bg-[#0b1220] border border-green-500/20 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-2xl">
            <div className="p-8 md:w-1/2 flex flex-col justify-center">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">Free Power Query & Integration Cheat Sheet</h2>
              <p className="text-justify text-sm text-gray-400 mb-8 max-w-md">
                Includes quick-reference instructions for Power Query data transformations, SQL connection strings, and automated refresh triggers.
              </p>
            ...
            <div className="p-8 md:w-1/2 bg-white/[0.02] backdrop-blur-sm flex items-center justify-center border-l border-[#1E2536]/50">
              <div className="bg-[#050B14] border border-[#1E2536]/50 rounded-xl p-5 w-full max-w-md font-mono text-xs shadow-xl">
                <div className="flex justify-between items-center mb-5 border-b border-[#1E2536]/50 pb-3">
                  <span className="text-gray-300 flex items-center gap-2"><FileText className="w-4 h-4 text-green-400"/> Excel_PowerQuery_CheatSheet.pdf</span>
                  <span className="bg-green-600/20 text-green-400 px-2 py-1 rounded text-[10px] font-bold">PDF 2.7 MB</span>
                </div>
                <div className="text-green-400 mb-2 font-semibold">1. Power Query Refresh Shortcut:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 mb-5 whitespace-pre-wrap">
                  &quot;Ctrl + Alt + F5 (Refresh All Data Connections & Queries)&quot;
                </div>
                <div className="text-green-400 mb-2 font-semibold">2. Power Query Editor Shortcut:</div>
                <div className="bg-black/50 p-3 rounded text-gray-300 border border-[#1E2536]/50 whitespace-pre-wrap">
                  &quot;Ctrl + Shift + F12 (Open Power Query Editor Window)&quot;
                </div>
                <div className="text-center text-gray-500 mt-6 text-[10px] italic">
                  + Complete ETL integration hotkeys in full PDF download
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-10">
            <div>
              <div className="flex items-center gap-3 mb-2">
                <h2 className="text-2xl md:text-3xl font-bold text-white">Integrations & Analytics Tutorials</h2>
                <span className="bg-green-600 text-white px-2.5 py-1 rounded-full text-xs font-bold">3 Guides</span>
              </div>
              <p className="text-justify text-sm text-gray-400 max-w-2xl">Explore advanced tutorials covering Power Query data flows, SQL connections, and Power BI report embedding.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Power Query</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Automating Data Cleaning Workflows Using Power Query ETL</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Learn how to merge multiple CSV files, unpivot columns, and automate repetitive data transformation tasks.</p>
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">SQL & Databases</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Connecting Excel Directly to SQL Server and Azure Databases</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Step-by-step instructions on setting up secure server connections, writing parameterized queries, and refreshing live feeds.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
            ...
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-2xl p-6 flex flex-col hover:border-green-500/30 transition-colors shadow-xl">
              ...
              <div className="flex gap-2 mb-4">
                <span className="bg-green-900/20 text-green-400 px-2 py-0.5 rounded text-[10px] font-semibold border border-green-500/10">Power BI Sync</span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2 leading-snug hover:text-green-400 transition-colors cursor-pointer">Publishing Excel Data Models to Power BI Dashboards</h3>
              <p className="text-justify text-sm text-gray-400 mb-6 flex-grow">Discover how to bridge traditional spreadsheet analytics with interactive cloud-based corporate dashboards.</p>
              <div className="flex items-center justify-between border-t border-[#1E2536]/50 pt-4">
                <span className="flex items-center gap-1 text-[10px] font-bold text-gray-500 tracking-widest uppercase bg-white/[0.02] px-2 py-1 rounded"><Play className="w-3 h-3 text-red-500 fill-current" /> Video</span>
                <Link href="/article-landing" className="text-xs font-bold text-green-400 hover:text-green-300 transition-colors">Read Full Tutorial →</Link>
              </div>
      ...
      <section className="py-16 bg-[#050B14]">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-justify text-sm text-gray-400 mb-8">Common technical questions regarding Integrations & Analytics in Microsoft Excel.</p>
          ...
          <div className="space-y-4">
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-green-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">How do I schedule automatic background data refreshes in Power Query?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
            <div className="bg-[#0b1220] border border-[#1E2536]/50 rounded-xl p-5 flex justify-between items-center cursor-pointer hover:border-green-500/30 transition-colors">
              <span className="text-sm font-semibold text-white">Can Power Query handle large datasets exceeding the Excel row limit?</span>
              <Plus className="w-5 h-5 text-gray-500" />
            </div>
          </div>
        </div>
